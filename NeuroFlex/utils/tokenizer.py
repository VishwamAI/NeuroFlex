...
class Tokenizer:
    ...
    def load_tokenizer(self, model_name: str, use_fast: bool = True):
        self.tokenizers["default"] = AutoTokenizer.from_pretrained(
    ...
    def add_special_tokens(self, special_tokens: List[str]):
        ...
        try:
            new_tokens = [
                ...
                if token not in self.tokenizer.special_tokens_map.values()
            ]
            if new_tokens:
    ...
    def encode(self, text: str, add_special_tokens: bool = True) -> List[int]:
        ...
        try:
            ...
            return self.tokenizers["default"].encode(
    ...
    def decode(
        self, token_ids: Optional[List[int]], skip_special_tokens: bool = True
    ) -> str:
        """
        ...
        try:
            ...
            decoded_text = self.tokenizers["default"].decode(
